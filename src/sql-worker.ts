...
try {
 db.exec("CREATE TABLE contas(conta_id TEXT PRIMARY KEY,tipo_conta TEXT,subtipo TEXT,nome TEXT,identificador_mascarado TEXT,saldo_centavos INTEGER,moeda TEXT,limite_credito_centavos INTEGER,limite_disponivel_centavos INTEGER,transacoes_no_periodo INTEGER)");
 ...
 db.exec("BEGIN");
 for(const a of workerData.accounts as AccountRow[]) insertAccount.run(a.conta_id,a.tipo_conta,a.subtipo,a.nome,a.identificador_mascarado,a.saldo_centavos,a.moeda,a.limite_credito_centavos,a.limite_disponivel_centavos,a.transacoes_no_periodo);
