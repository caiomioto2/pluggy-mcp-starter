...
export const schema = {
 ...
 conta_id:"TEXT",tipo_conta:"BANK ou CREDIT",subtipo:"TEXT ou NULL",nome:"TEXT ou NULL",
 ...
 example:"SELECT conta_id,nome,identificador_mascarado,tipo_conta,transacoes_no_periodo FROM contas ORDER BY tipo_conta,nome"
};
